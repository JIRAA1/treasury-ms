...
CREATE TABLE IF NOT EXISTS system_settings (key TEXT PRIMARY KEY, value TEXT); INSERT INTO system_settings (key, value) VALUES ('promptpay_id', '0934589920'), ('promptpay_name', '�ҹ� �.');
